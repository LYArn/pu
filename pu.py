...
def plot(history, name, batch_size, lrate):
...
if __name__ == "__main__":
    ...
    save_name = f"{path_save}/{test}_adjusted_batch{batch_size}_lr{str(lrate).split('e')[-1]}"
    ...
    plot(hist, save_name,  batch_size, lrate)
